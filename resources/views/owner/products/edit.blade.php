                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('owner.products.update', ['product' => $product->id]) }}" method="post">
                        ...
                        <div class="-m-2">
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                    <label for="current_quantity" class="leading-7 text-sm text-gray-600">在庫数
                                        ※必須</label>
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative flex justify-around">
                                    <div><input type="radio" class="mr-2" name="type" value="{{ \Constant::PRODUCT_LIST["add"] }}" checked>追加
                                    </div>
                                    <div><input type="radio" class="mr-2" name="type" value="{{ \Constant::PRODUCT_LIST["reduce"] }}">削減</div>
                                </div>
                            </div>
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                        ...
                        <div class="p-2 w-1/2 mx-auto">
                            <div class="relative flex justify-around">
                                <div><input type="radio" class="mr-2" name="is_selling" value="1"
                                        @if ($product->is_selling === 1) {checked} @endif>販売中
                                </div>
                                <div><input type="radio" class="mr-2" name="is_selling" value="0"
                                        @if ($product->is_selling === 0) {checked} @endif>販売停止中</div>
                            </div>
                        </div>
