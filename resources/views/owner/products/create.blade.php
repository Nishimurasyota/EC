                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('owner.products.store') }}" method="post">
                        ...
                        <div class="-m-2">
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                    <label for="categoru" class="leading-7 text-sm text-gray-600">カテゴリー</label>
                        ...
                        <div class="p-2 w-1/2 mx-auto">
                            <div class="relative flex justify-around">
                                <div><input type="radio" class="mr-2" name="is_selling" value="1" checked>販売中
                                </div>
                                <div><input type="radio" class="mr-2" name="is_selling" value="0">販売停止中</div>
                            </div>
                        </div>
