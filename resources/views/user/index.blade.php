                ...
                <div class="flex">
                    <div>
                        ...
                        <select id="sort" name="sort" class="mr-4">
                            ...
                            <option value="{{ \Constant::SORT_ORDER['later'] }}"
                                @if (\Request::get('sort') === \Constant::SORT_ORDER['later']) selected @endif>最新順
                            </option>
                    ...
                    <div>
                        ...
                        <select id="pagination" name="pagination">
                            ...
                            <option value="50" @if (\Request::get('pagination') === '50') selected @endif>20件
                            </option>
                            <option value="100" @if (\Request::get('pagination') === '100') selected @endif>20件
                            </option>
                        </select>
                    </div>
                </div>
                                    ...
                                    <div class="border rounded-md p-2 md:p-4">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <p class="mt-1">{{ number_format($product->price) }}<span
                                                    class="text-sm text-gray-500">円（税込）</span></p>
                                        </div>
                                    </div>
                                </a>
                            </div>
