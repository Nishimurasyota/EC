                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="md:flex md:justify-around">
                        ...
                        <div class="md:w-1/2 ml-4">
                            <h2 class="mb-4 text-sm title-font text-gray-500 tracking-widest">{{ $product->name }}
                            </h2>
                    ...
                    <div class="mb-4 text-center">
                        <button type="button"
                            ...
                            class="text-white bg-gray-400 border-0 py-2 px-6 focus:outline-none hover:bg-gray-500 rounded">
                            ショップの詳細を見る
                        </button>
                    </div>
                </div>
